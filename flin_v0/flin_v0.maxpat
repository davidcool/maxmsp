...
, 			{
				"box" : 				{
					"allowdrag" : 0,
					"id" : "obj-179",
					"items" : [ "AU DLS Synth 1", ",", "Casio USB Keyboard", ",", "Oxygen 49", ",", "USB2.0-MIDI Port 1", ",", "USB2.0-MIDI Port 2", ",", "USB2.0-MIDI Port 1 #2", ",", "USB2.0-MIDI Port 2 #2", ",", "Seaboard RISE", ",", "iPad", ",", "Pro40 MIDI", ",", "from Max 1", ",", "from Max 2", ",", "from Max 3", ",", "from Max 4", ",", "from Max 5", ",", "from Max 6" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
